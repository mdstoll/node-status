...
enum IdentityStore {
    ...
    static func save(serverID: UUID, clientCertPEM: String, caCertPEM: String, token: String) throws {
        ...
        Keychain.storeCertificate(clientCert, label: "nodestatus-client-\(serverID.uuidString)")
    ...
    static func remove(serverID: UUID) {
        ...
        Keychain.deleteCertificate(label: "nodestatus-client-\(serverID.uuidString)")
