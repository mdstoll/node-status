...
enum ConnectionState: Equatable, Sendable {
    ...
    var detail: String? {
        switch self {
        case .failed(let m): m
        case .connecting: "Verbinding maken met de server…"
        case .reconnecting: "De verbinding is weggevallen; opnieuw proberen…"
        default: nil
        }
    }
...
final class AppState {
    ...
    /// Gezet door een serverinfo://enroll-deeplink; de Server-tab pakt hem op.
